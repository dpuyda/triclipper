...
std::vector<Parameters<OperationType::kMerge>> CreateParameters() {
...

  {
    ...
    test.polygons.push_back({{0, 0}, {50, 50}, {30, 10}, {20, 0}});
...

  {
    ...
    test.polygons.push_back({{0, 0}, {50, 50}, {30, 20}, {20, 10}, {60, 0}});
    test.polygons.push_back({{60, 0}, {70, 10}, {80, 0}});
    test.polygons.push_back({{80, 0}, {70, 10}, {50, 50}, {100, 0}});
    test.polygons.push_back({{20, 10}, {30, 20}, {40, 10}});
    test.polygons.push_back(
...

  {
    ...
    test.polygons.push_back({{40, 10}, {50, 20}, {60, 10}});
