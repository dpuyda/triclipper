...
std::vector<Parameters<OperationType::kUnion>> CreateParameters() {
...

  {
    ...
    test.polygons.push_back({{30, 0}, {0, 30}, {60, 60}, {50, 40}, {40, 20}});
    test.polygons.push_back({{50, 10}, {40, 20}, {50, 40}, {70, 50}});
  }

  {
    ...
    test.polygons.push_back({{20, 0}, {0, 20}, {60, 20}, {30, 10}});
    test.polygons.push_back({{40, 0}, {30, 10}, {60, 20}});
  }

  {
    ...
    test.polygons.push_back({{30, 0}, {10, 20}, {50, 20}});
    test.polygons.push_back({{10, 20}, {0, 30}, {40, 30}, {30, 20}});
  }

  {
    ...
    test.polygons.push_back({{20, 0}, {0, 20}, {40, 20}});
    test.polygons.push_back({{20, 20}, {10, 30}, {50, 30}, {40, 20}});
  }

  {
    ...
    test.polygons.push_back({{30, 0}, {10, 20}, {50, 20}});
    test.polygons.push_back({{10, 20}, {0, 30}, {60, 30}, {50, 20}});
  }

  {
    ...
    test.polygons.push_back({{0, 0}, {0, 20}, {10, 15}, {20, 10}, {40, 0}});
    test.polygons.push_back({{40, 0}, {20, 10}, {40, 20}});
    test.polygons.push_back({{20, 10}, {10, 15}, {10, 20}});
  }

  {
    ...
    test.polygons.push_back({{0, 0}, {0, 20}, {10, 15}, {20, 10}, {40, 0}});
    test.polygons.push_back({{40, 0}, {20, 10}, {30, 20}, {30, 15}});
    test.polygons.push_back({{20, 10}, {10, 15}, {10, 20}});
    test.polygons.push_back({{40, 0}, {30, 15}, {40, 20}});
  }

  {
    ...
    test.polygons.push_back({{0, 0}, {0, 10}, {40, 10}, {40, 0}});
    test.polygons.push_back({{0, 10}, {0, 20}, {7, 17}, {40, 10}});
    test.polygons.push_back({{40, 10}, {7, 17}, {20, 30}, {34, 17}});
    test.polygons.push_back({{40, 10}, {34, 17}, {40, 20}});
  }
