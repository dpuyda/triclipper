...
std::vector<Parameters<OperationType::kMerge>> CreateParameters() {
...

  {
    ...
    polygons.push_back({{50, 10}, {60, 20}, {70, 10}});
...

  {
    ...
    polygons.push_back({{50, 20}, {40, 30}, {60, 30}});
    polygons.push_back({{60, 10}, {50, 20}, {60, 30}, {50, 50}, {70, 20}});
  }
...

  {
    ...
    polygons.push_back({{100, 0},
                        ...
                        {60, 10}});
    polygons.push_back({{60, 10}, {70, 20}, {80, 10}});
    polygons.push_back({{100, 0}, {60, 10}, {80, 10}, {70, 20}, {70, 30}});
    polygons.push_back({{60, 20}, {50, 30}, {70, 30}});
    polygons.push_back({{60, 10}, {60, 20}, {70, 30}, {70, 20}});
  }

  {
    ...
    polygons.push_back({{0, 0}, {30, 30}, {30, 20}, {20, 10}, {100, 0}});
    polygons.push_back({{20, 10}, {30, 20}, {40, 10}});
    polygons.push_back(
        {{100, 0}, {20, 10}, {40, 10}, {30, 20}, {30, 30}, {40, 20}, {60, 10}});
    polygons.push_back({{60, 10}, {70, 20}, {80, 10}});
    polygons.push_back({{100, 0}, {60, 10}, {80, 10}, {70, 20}, {50, 50}});
    polygons.push_back({{40, 20}, {30, 30}, {50, 30}});
    polygons.push_back(
